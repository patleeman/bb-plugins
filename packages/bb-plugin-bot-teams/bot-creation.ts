...
export function botCreationPrompt(room?: Pick<Room, "id" | "name">): string {
  return [
    ...
    "Create the bot once its purpose is clear. Write its mission and configure it yourself; do not give me commands to run. Keep scheduled mission work paused and the interval at 0 unless I ask for a schedule. Use the default permissions unless I request otherwise.",
    ...(room
      ? [
